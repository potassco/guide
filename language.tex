...
\end{lstlisting}
%
This program has the same answer set as the one in Example~\ref{ex:as:one}
...
Without this, \pred{a} and~\pred{b} can thus be both true or false, just like in classical logic.
