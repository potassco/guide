...
\index{Boolean Literals}\comment{Should we give the index a bit more structure?}
%
Sometimes it is usefull to have literals that evaluate to a constant truth value.
\emph{Boolean literals} over the two \emph{Boolean atoms} \code{\#true} and \code{\#false} evaluate to either true or false,
...
The body of the last three integrity constraints is false.
Hence, the constraints do not cause a conflict.
Note that neither of the rules above derive any predicate atoms.
