...
\comment{M2R: I dropped the footnote because I needed quite some consideration
         ...
         R: The footnote might have been a bit complicated. 
            I added it because I think it was interesting (and still think so).}%
...
\comment{M: I didn't get what the previous sentence is aiming at.
         ...
         R: My point is: variable occurrences in the scope of external functions are not considered bound, which is similar to variable occurrences in arithmetics.
            We can also write it like this if you prefer.}
\end{example}
