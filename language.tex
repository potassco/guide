...
\comment{JR: this ``tuple'' strikes me a bit, then I have the doubt about whether they should go in parentheses.\par
  ...
  TS: I agree but shouldn't we do this, where tuples get defined?}
...
The student's first condition is to enrol in~\const{3} to~\const{6} courses.
%
...
\marginlabel{%
  ...
  \code{gringo~--text~\attach{examples/aggr.lp}{aggr.lp}}}
%
\begin{lstlisting}[numbers=none]
