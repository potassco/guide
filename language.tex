...
\lstinputlisting[language={[5.1]Lua}]{examples/term-lua.lp}
\end{minipage}
\begin{minipage}[t]{0.45\textwidth}
\lstinputlisting[language=python]{examples/term-py.lp}
\end{minipage}\\
...
\\[-8pt] % is there a better way to do this?
\begin{minipage}[t]{0.57\textwidth}
\lstinputlisting[language={[5.1]Lua}]{examples/cmp-lua.lp}
\end{minipage}
\begin{minipage}[t]{0.45\textwidth}
\lstinputlisting[language=python]{examples/cmp-py.lp}
\end{minipage}\\
