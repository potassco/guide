...
\url{http://potassco.sourceforge.net/gringo.html} for Version~4.5.4
(and at \url{http://potassco.org/clingo} for series~5).
...
the \code{number} property is used to get the numeric representation of a term from object of type \code{Symbol}.
...
Unlike other termes both are captured by unique objects.
...
(and since version~3.2 additionally in \aspif{} format~\cite{kascwa17a}),
