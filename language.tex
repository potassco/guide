...
\[
\mathsf{\mu}\,\code{\{}\,\boldsymbol{t}_1:\boldsymbol{L}_1@p_1,\dots,\boldsymbol{t}_n:\boldsymbol{L}_n@p_n\,\code{\}}
\] 
...
(as introduced in Section~\ref{subsec:gringo:normal}),
and $p_i$ are optional (integer) priorities.\comment{T: @ with tuples??}
