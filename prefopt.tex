...
Here, ${w}$ is an integer, $\boldsymbol{t}$ a sequence of comma-separated terms, and $F$ a Boolean formula.
%
...
$\boldsymbol{t}$ a sequence of comma-separated terms, and $F$ a Boolean formula.
%
