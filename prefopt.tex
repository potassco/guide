...
\label{sec:prefopt}
\comment{C: Please write a few words for an introduction of this section}
...
that we put together in the file \code{preference8.lp} along with an optimize statement for \code{p8}:
%
