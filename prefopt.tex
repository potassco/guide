...
\par also we need: \textit{not}\par PROPAGE CHANGE \par J: I think what we have is enough now :)\par T: Mmmh, let's discuss :)}, $\code{\_and/2}$, and $\code{\_or/2}$ in prefix notation.
For example, 
...
\begin{example}
\comment{JR: This is a ground preference specification, maybe we could add variables.\par T: See above ;) \par J: I will change this later once we agree on the example.\par T: Agreed :)}
