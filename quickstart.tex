...
\comment{JR: Style note: This looks too complicated to me, 
             specially because it may be understood that actually some ASP projection is happening. %\comment{JR
             One could say, f.e. ``allows for showing only some predicates of the program''.} % \comment{JR
