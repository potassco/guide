...
%
\begin{lstlisting}[numbers=none,escapechar=@]
@\textit{Location}@: parse error: @\textit{Message}@
\end{lstlisting}
%
...
\end{lstlisting}
where \codeit{Information} indicates why the aggregate is nonmontone
- for example because of negative weights in a \code{\#sum} aggregate.
