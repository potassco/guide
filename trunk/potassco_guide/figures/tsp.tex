...
%
\put(92,75){\color{BlueViolet}\thicklines\vector(1,0){96}}  % 1 -> 2
\put(137.5,77){\color{BlueViolet}$\mathbf{2}$}
\put(80,87){\vector(0,1){46}}  % 1 -> 3
\put(73,107){$3$}
\put(130,30){\vector(1,-1){0}} % \put(91,69){\vector(1,-1){39}} % 1 -> 4
\put(111,50){\color{BlueViolet}$\mathbf{1}$}
%
\put(189,69){\vector(-1,-1){39}} % 2 -> 4
\put(163,50){$2$}
\put(200,87){\color{BlueViolet}\thicklines\vector(0,1){46}}   % 2 -> 5
...
\put(127.8,25){\color{BlueViolet}\thicklines\vector(4,-1){2}} % 3 -> 4
\put(45,85){\color{BlueViolet}$\mathbf{2}$}
\put(92,145){\vector(1,0){96}}   % 3 -> 5
\put(137.5,147){$2$}
%
\put(130,30){\color{BlueViolet}\thicklines\vector(-1,1){39}} % 4 -> 1
...
\put(230,85){$2$}
\put(190,139){\color{BlueViolet}\thicklines\vector(-3,-2){39}} % 5 -> 6
\put(166,127){\color{BlueViolet}$\mathbf{1}$}
%
\put(151,107){\vector(3,-2){39}} % 6 -> 2
\put(129,113){\color{BlueViolet}\thicklines\vector(-3,2){39}} % 6 -> 3
\put(110,127){\color{BlueViolet}$\mathbf{3}$}
\put(190,139){\vector(3,2){0}} % \put(151,113){\vector(3,2){39}}  % 6 -> 5
%
\end{picture}
\end{center}
