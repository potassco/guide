...
\com{RK: mention packages available in distributions here!}
...
\comment{M: The outline is extended to all sections, please cross-check!
            Also, should the draft character of some sections
            be mentioned here?}
