...
To support this reasoning mode, \gringo\ and \clingo\ adopt dlv's weak constraints.\comment{add a citation}
...
The safety requirements for the body itself are the same as for integrity constraints.
