...
Note that comparison predicates can be preceded with \code{not} or \code{not}~\code{not}.
In the first case, this is equivalent to using the complementary comparison predicate 
...
Like with comparison predicates, the prefix \code{not~not} has no effect.
