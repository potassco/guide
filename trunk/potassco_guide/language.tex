...
For instance, the sum of this semester's course credits must be at least 20, or sum of the prizes of my shopping items should not exceed 30 euros.
...
{a; not a;not not a}.
\end{lstlisting}
is expanded by \gringo\ to\comment{T2R: Was machen wir mit dem \#true?}
\begin{lstlisting}[numbers=none]
#count{ 1,0,a : a; 
        1,1,a : #true : not a; 
