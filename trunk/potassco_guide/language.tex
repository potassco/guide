...
does not count as a positive occurrence in the sense of safety\comment{RK: safety vs. safety; X in X+1 is actually safe} (cf.\ Page~\pageref{pg:safe}).
...
The following built-in predicates\comment{RK: safety? these can be used like literals now}, which are evaluated during grounding, 
