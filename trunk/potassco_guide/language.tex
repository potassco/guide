...
For example, the tuple \code{(1;2,3)} expands into \code{(1)}, \code{(2,3)}.
Hence, \code{(1)} is note a tuple here but equal to integer \code{1}.}
...
\comment{RK: how do we structure the index? T: As you wish :)}
