...
\footnote{Note that \gringo's shortcut expansion of \lstinline{:- \{ course(C,S,H) : enroll(C) \} 10.} is equivalent to the rule in Line~10.}
%
...
additionally, priorities can be associated with each weighted literal.\comment{Käse}
