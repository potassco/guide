...
\index{Terms!Arithmetic Functions!Addition, \code{+}}
\index{Terms!Arithmetic Functions!Subtraction, \code{-}}
\index{Terms!Arithmetic Functions!Unary Minus, \code{-}}
\index{Terms!Arithmetic Functions!Multiplication, \code{*}}
\index{Terms!Arithmetic Functions!Division, \code{/}, \code{\#div}}
\index{Terms!Arithmetic Functions!Modulo, \code{\textbackslash}, \code{\#mod}}
\index{Terms!Arithmetic Functions!Exponentiation, \code{**}, \code{\#pow}}
\index{Terms!Arithmetic Functions!Absolute Value, \mbox{\textbar$\cdot$\textbar}, \code{\#abs}}
\index{Terms!Arithmetic Functions!Bitwise AND, \code{\&}}
\index{Terms!Arithmetic Functions!Bitwise OR, \code{?}}
\index{Terms!Arithmetic Functions!Bitwise XOR, \code{\^}}
\index{Terms!Arithmetic Functions!Bitwise Complement, \code{\textasciitilde}}
