...
we show how to take complete control of the grounding and solving process using the scipting API.
...
Outline:
simple arithmetic functions (gcd example is nice),
...
returning multiple values (range example, mention fetch instance from database),
