...
Hence, we have that
only either~\pred{a} or~\pred{b} constitute
the two answer sets of the logic program.
\eexample
\end{example}
...
atom \pred{c} must uncoditionally be true,
so that it belongs to every model.
In view of this,
