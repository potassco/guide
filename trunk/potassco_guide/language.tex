...
\begin{align*}
\textbf{Rule:} & \quad A_0\code{;}\dots\code{;}A_m~\code{:-}~L_1\code{,}\dots\code{,}L_n\code{.} \\
\textbf{Fact:} & \quad A_0\code{;}\dots\code{;}A_m\code{.}
\end{align*}
...
%
\[s_1\prec_1\alpha\code{\{}\boldsymbol{t}_1\code{:}L_1\code{:}\boldsymbol{L_1}\code{;}\dots\code{;}\boldsymbol{t}_n\code{:}L_n\code{:}\boldsymbol{L_n}\code{\}}\prec_2 s_2\]
%
