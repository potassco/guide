...
Can be used in conjunction with the \code{--text} option to print a program in a (human-readable) similar to the lparse format,
...
\begin{description}[leftmargin=6cm,style=nextline,align=right,font=\code]
  ...
  \item[define-cyclic]            See Section~\ref{sec:warn:cycdef}.
  \item[define-redefinition]      See Section~\ref{sec:warn:redef}.
