...
\marginlabel{%
  ...
  asprin.lib 0}}
%
Along with the base program of Example \ref{asprin:example1}, \asprin\ produces answer sets $X_2$ and $X_3$. 
Optimizing \code{p7} or \code{p8}, we obtain the three answer sets $X_1$, $X_2$ and $X_3$, 
while optimizing \code{p9} we get simply $X_2$.
\end{example}
