...
\code{subset} maps every such set $E$ of ground preference elements to the preference relation defined as: 
\(
...
For example, \code{p1} declares the following preference relation $\succ_{\code{p1}}$:
\begin{tabular}{ccl}
...
whereas $M_2$ is not because $M_1 \succ_{\code{p1}} M_2$. 
