...
\index{optimization!preference type}
...
\index{optimization!preference type!\code{subset}}
\index{optimization!preference type!\code{superset}}
\index{optimization!preference type!\code{less(cardinality)}}
\index{optimization!preference type!\code{more(cardinality)}}
\index{optimization!preference type!\code{less(weight)}}
\index{optimization!preference type!\code{more(weight)}}
\index{optimization!preference type!\code{aso}}
\index{optimization!preference type!\code{poset}}
...
\index{optimization!preference type!\code{neg}}
\index{optimization!preference type!\code{and}}
\index{optimization!preference type!\code{pareto}}
\index{optimization!preference type!\code{lexico}}
...
\marginlabel{%
  ...
  \code{\mbox{~}asprin \attach{examples/base.lp}{base.lp} \
  \attach{examples/preference1.lp}{preference1.lp} \ 
  \attach{examples/subset.lp}{subset.lp} \ 
  \attach{examples/basic.lp}{basic.lp} 0}}
\begin{lstlisting}[numbers=none,escapechar=\%]
...
\marginlabel{%
  To inspect the output, invoke:\\
  \code{\mbox{~}asprin \attach{examples/base.lp}{base.lp} \
  \attach{examples/preference8.lp}{preference8.lp} \ 
  \attach{examples/basic.lp}{basic.lp}   \
  \attach{examples/pareto.lp}{pareto.lp} \ 
  \attach{examples/subset.lp}{subset.lp} \ 
  \attach{examples/less-cardinality.lp}{less-cardinality.lp} 0}} 
\begin{lstlisting}[numbers=none,escapechar=\%]
asprin %\attach{examples/base.lp}{base.lp}% %\attach{examples/preference8.lp}{preference8.lp}%  %\attach{examples/basic.lp}{basic.lp}% \
        %\attach{examples/pareto.lp}{pareto.lp}% %\attach{examples/subset.lp}{subset.lp}% %\attach{examples/less-cardinality.lp}{less-cardinality.lp}% 0
\end{lstlisting}
