...
in the following encoding\comment{RK: would it make sense to use an aggregate of form not \{ ... \} = 1 here}:%
...
along bigger disks.\comment{RK: along bigger disks sounds strange. Maybe: to all bigger disks on the same peg}
...
rules of denial\comment{RK: maybe remove the of denial thing} that eliminate unintended solution candidates.
